/* Universidade de Brasília - UnB
   Departamento de Ciencia da Computação - CIC
   Alunos: Lucas Correa Lemos - 17/0149412, Gabriel de Oliveira Estevam - 17/0142591 
*/
    ...
    public static void trata_opcao(int opcao) {
        ...
        case OP_CRIAR_CONTA:
            ...
            if (tipo != 1 && tipo != 2 && tipo != 3) {
                ...
                System.out.println("Favor entre com numero da conta e tecle Enter:");
                numero = sc.nextLine();
                System.out.println("Favor entre com o nome do cliente e tecle Enter:");
                nome = sc.nextLine();
                System.out.println("Favor entre com o cpf do cliente e tecle Enter:");
                cpf = sc.nextLine();
                cliente = new Cliente(cpf,nome);
        ...
        case OP_DEBITAR_CONTA:
            System.out.println("Favor entre com o numero da conta e  tecle Enter:");
            numero = sc.nextLine();
            System.out.println("Favor entre com o valor a ser debitado e  tecle Enter:");
            valor = sc.nextDouble();
        ...
        case OP_TRANSFERIR_CONTAS:
            ...
            System.out.println("Favor entre com o numero da conta de origem e tecle Enter:");
            origem = sc.nextLine();
            System.out.println("Favor entre numero da conta de destino e tecle Enter:");
            destino = sc.nextLine();
            System.out.println("Favor entre com o valor a ser transferido e  tecle Enter:");
            valor = sc.nextDouble();
        ...
        default:
            System.out.println("Opcao invalida! Favor entrar uma opcao entre 1 e 17");
